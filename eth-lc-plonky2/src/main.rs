...
fn main() {
    ...
    let cur_state = [150, 97, 120, 105, 126, 50, 222, 233, 169, 14, 3, 45, 102, 32, 221, 69, 151, 120, 157, 18, 19, 66, 229, 81, 65, 253, 180, 52, 214, 21, 206, 131];
    let new_state = [138, 202, 109, 111, 105, 232, 211, 47, 153, 145, 225, 113, 61, 169, 147, 26, 82, 43, 39, 187, 51, 189, 135, 92, 146, 108, 100, 39, 249, 104, 231, 198];
